  ...
  return (
    <div className="bg-[#1B73F4] min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="mt-2 md:mt-3 lg:mt-5  flex flex-col justify-center items-center space-y-5 md:space-y-10 lg:space-y-20">
          {/**buttons */}
          <div className="flex gap-2 md:gap-3 lg:gap-5 mt-2 lg:mt-3">
            <button className="  px-5 py-2 md:px-7 md:py-2  lg:px-10  lg:py-3 bg-white text-blue-600 hover:cursor-pointer hover:shadow-xl hover:bg-blue-300 rounded-sm  md:rounded-lg lg:rounded-xl">
              Start exploring
            </button>
          </div>
          {/**cards */}
          <div className=" flex flex-col md:flex-row  lg:flex-row  space-x-4 lg:space-x-5 ">
            {/**cards1 */}
            <div className="h-32 w-full md:h-36 md:w-48 lg:h-40 lg:w-54 p-5 bg-blue-300 rounded-lg shadow-md flex hover:cursor-pointer hover:bg-blue-400 hover:shadow-xl  flex-col items-center  justify-end">
              <p className="text-white ">Write journals</p>
              <p className="mb-4">Document your travel experience</p>
            </div>
            {/**card2 */}
            <div className="h-32 w-full md:h-36 md:w-48 lg:h-40 lg:w-54 p-5 bg-blue-300 rounded-lg shadow-md  hover:cursor-pointer hover:bg-blue-400  hover:shadow-xl flex  flex-col items-center justify-end">
              <p className="text-white text-center">Add Photos</p>
              <p className="mb-4">Upload memories from your trip</p>
            </div>
            {/**card3 */}
            <div className=" lg:h-40 lg:w-54 p-5 bg-blue-300 rounded-lg shadow-md  hover:cursor-pointer hover:bg-blue-400 hover:shadow-xl flex  flex-col items-center justify-end">
